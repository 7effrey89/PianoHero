    ...
    renderNotes(fallingNotes, keyPositions, config) {
        ...
        for (let i = 0; i < fallingNotes.length; i++) {
            ...
            if (isClassic) {
                ...
                if (rect) classicNoteRects.push(rect);
            } else {
        ...
        const waveCount = config.waveCount || 0;
        if (isClassic && classicNoteRects.length > 0 && waveCount > 0) {
            ...
            this._drawWaveOverlay(wg, w, h, waveCount);
        }
